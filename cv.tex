...
\cventry{October 2016}{CVE-2016-3917}{Android Open Source Project}{}{}{I discovered a high-severity security vulnerability in the Android Operating System.}  % arguments 3 to 6 can be left empty
\cventry{November 2015}{Travel Fellow}{ESBB}{London, United Kingdom}{}{I won a scholarship to showcase ILRI's biorepository software stack at a conference by the European, Middle Eastern and African Society for Biopreservation and Biobanking (ESBB).}  % arguments 3 to 6 can be left empty
\cventry{May 2013}{First Class Honours}{University of Nairobi, B.Sc. Computer Science}{Nairobi, Kenya}{}{For attaining more than 70\% in my average score for the course.}  % arguments 3 to 6 can be left empty

\section{Computer Skills}
\cvitem{Proficient}{Git, Bash, GNU Linux, Ansible, Terraform, Packer, AWS, Java}
\cvitem{Intermediate}{Go, Python, Rust, Docker, Kubernetes, Helm, GoCD}
...
\cvitem{Gardening}{An avid plan parent}
